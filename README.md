...
```
index.html              整支 App（含全部講義與教學講章，約 4.5 MB）
manifest.webmanifest    PWA 設定：名稱、圖示、啟動畫面顏色
sw.js                   Service Worker，讓 App 離線也能讀
icons/                  圖示（32／64／120／152／167／180／192／512／1024）
favicon.ico             瀏覽器分頁圖示
...
架構、操作方式與功能，與《321創世記講義》完全一致。

底下五格：**今日｜經文｜課程｜工具｜我的**

每一章七格分頁：**卡片｜核心｜小組｜講章｜講義｜操練｜把關**

- **講義**就是四十課的教學講章：十一節全文、想更深可收合、
  小組討論分享三個化，可開**全螢幕**逐段帶讀
- **工具**六樣：搜尋、原文軌跡（5 條）、爭議地圖（262 組）、
  全書地形圖、金句複習（間隔重複）、講台把關總覽
- **朗讀**：真人語音（Azure）＋裝置內建語音，可挑聲音與語速，背景播放
- **畫線與領受**：長按選字畫線、五色、寫領受、可匯出
- **小智**：陪讀小幫手，帶著本章的經文與解經上下文回答
- **繁／简**一鍵切換，**加到主畫面**後離線可讀
